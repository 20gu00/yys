...
type (
	...
	ListPaymentItemResp                  = pb.ListPaymentItemResp
	ListPaymentReq                       = pb.ListPaymentReq
	ListPaymentResp                      = pb.ListPaymentResp
...
// provide to admin use
func (m *defaultPayment) ListPayment(ctx context.Context, in *ListPaymentReq, opts ...grpc.CallOption) (*ListPaymentResp, error) {
	client := pb.NewPaymentClient(m.cli.Conn())
	return client.ListPayment(ctx, in, opts...)
}
