...
type PaymentClient interface {
	...
	ListPayment(ctx context.Context, in *ListPaymentReq, opts ...grpc.CallOption) (*ListPaymentResp, error)
}
...
func (c *paymentClient) ListPayment(ctx context.Context, in *ListPaymentReq, opts ...grpc.CallOption) (*ListPaymentResp, error) {
	out := new(ListPaymentResp)
	err := c.cc.Invoke(ctx, "/pb.payment/ListPayment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServer interface {
	...
	//provide to admin use
	ListPayment(context.Context, *ListPaymentReq) (*ListPaymentResp, error)
...
func (UnimplementedPaymentServer) ListPayment(context.Context, *ListPaymentReq) (*ListPaymentResp, error) {
...
func _Payment_ListPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.payment/ListPayment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).ListPayment(ctx, req.(*ListPaymentReq))
	}
	return interceptor(ctx, in, info, handler)
}
